...
import io.github.felipebonezi.cipherizy.algorithm.Base64Cipher;
...
public class Base64URLSafeCipherTest {
  ...
  public void whenDataIsEncryptedToBase64_thenEncryptSuccessfully() throws CipherException {
    ...
    Base64Cipher  base64Cipher = (Base64Cipher) cipherBase64;
    base64Cipher.setUrlSafe(true);
